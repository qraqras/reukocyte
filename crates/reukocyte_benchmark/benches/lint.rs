...
fn generate_ruby_source(methods: usize, with_debuggers: bool) -> Vec<u8> {
...
fn bench_debugger(c: &mut Criterion) {
    let mut group = c.benchmark_group("Lint/Debugger");
...
criterion_group!(benches, bench_debugger, bench_real_world_file);
